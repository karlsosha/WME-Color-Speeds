...
*/
    ...
    function setupHandler() {
        ...
        $("#cbMultiplePalette").on("click", function () {
            $("#selectState").css("display", $(this)[0].checked ? "block" : "none");
            WMECSpeeds.MultiplePalette = $(this)[0].checked;
    ...
    function SCColor() {
        ...
        for (const seg of sdk.DataModel.Segments.getAll()) {
            ...
            if (WMECSpeeds.PaletteByCountrie &&
                ...
                updateCountriesList();
                LoadSettings();
                log(`SCColor WMECSpeeds.speedColors.Countries.${country}.${unit} = `, WMECSpeeds.speedColors?.Countries[country][unit]);
            }
            if (WMECSpeeds.MultiplePalette === true &&
